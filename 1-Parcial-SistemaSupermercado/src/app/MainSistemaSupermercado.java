...
public class MainSistemaSupermercado 
{
	private Supermercado supermercado; 

	public MainSistemaSupermercado() {
		super();
...
//	}
	public static void main(String[] args) throws IOException 
	{
		...
		MainSistemaSupermercado main = new MainSistemaSupermercado();
...
//		
	...
	public void crearProductoComp() 
	{
		try
		{
			...
			supermercado.crearProductoComp(cod, nombre, precio, stock);
		}
		catch(Exception e){}
	...
	private void crearVenta(){
		try
		{
			...
			String dni = reader.readLine();
			int nroVenta = supermercado.crearVenta(dni);
			...
			while (opcion.equalsIgnoreCase("Y")){
				...
				supermercado.agregarItem(nroVenta,cod,cant);
	...
	private void listarClientes() 
	{
		try
		{
			...
			ListClientes listaCliente = supermercado.getClientes();
			for(Cliente cli : listaCliente.getClientes())
			{
	...
	private void listarProductos() 
	{
		try
		{
			...
			ListProductosSimple listaProductosSimple = supermercado.getProductosSimple();
			...
			ListProductosComp listaProductosComp = supermercado.getProductosComp();
	...
	private void listarVentas() 
	{
		...
		{	
			...
			ListVentas listaVentas = supermercado.getVentas();
			for(Venta v : listaVentas.getVentas())
			{
	...
	private void obtenerDetalleVenta() 
	{
		try
		{
			...
			int cod = Integer.parseInt(reader.readLine());
			ListVentas listaVentas = supermercado.getVentas();
			Venta v = listaVentas.getVentaPorId(cod);
			List<ItemVenta> listaItemsVenta  = v.getItemsVenta();
